...
def number_of_military_branches():
    return 5
print(number_of_days_in_a_week_silicon_or_triangle_sides() + number_of_military_branches()) #none
...
        return 10
    return 7
print(number_of_oceans_or_fingers_or_continents()) #none
...
def foobar():
    ...
    return b
print(b) #500
b=foobar() #300 The return gives the value of 300 to b
print(b) #300 
