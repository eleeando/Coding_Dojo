...
// if the 1st condition is not true (in this case there is no type[1]) the program will give us a false result

// 3. console.log the names of the pokémon whose only type is "poison"
// for (var i=0; i<pokemon.length; i++){
//     if(pokemon[i].types.length===1 && pokemon[1].types[0]==="poison"){
//         console.log(pokemon[i])
//         }
//     }
// example
...
// arrayA.push(101)
// arrB.push(96)
// console.log(arrA) ==>[55,33,11,101,96]
// console.log(arrB) ==>[55,33,11,101,96]
